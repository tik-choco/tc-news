...
const ja = {
  ...
  rankingHint: "今日もらったリアクションと閲覧数で記事と番組をランキングします。",
  rankingEmpty: "今日はまだリアクションも閲覧もありません。気に入った記事にリアクションを送ってみましょう!",
  rankingReactions: "{count} リアクション",
  rankingViews: "{count} 閲覧",
...
const en: typeof ja = {
  ...
  rankingHint: "Articles and programs ranked by reactions and views received today.",
  rankingEmpty: "No reactions or views yet today. Send one to an article you like!",
  rankingReactions: "{count} reactions",
  rankingViews: "{count} views",
