...
// settings screen's TTS voice field. Ported from tc-town's lib/voices.ts.
//
...
// error path (see VoiceField in views/SettingsView.tsx).
...
export async function fetchVoices(
  ...
  throw new Error(tGlobal("errors.voiceListFailed"));
}
